...
LUA_API lua_State *lua_newstate(lua_Alloc f, void *ud)
{
	...
	g->gcstopem = 0;
	g->gcemergency = 0;
	g->finobj = g->tobefnz = g->fixedgc = nullptr;
	g->firstold1 = g->survival = g->old1 = g->reallyold = nullptr;
	g->finobjsur = g->finobjold1 = g->finobjrold = nullptr;
	g->sweepgc = nullptr;
